...
export enum InputMode {
    ...
    INPUT_MODE_PS3 = 2,
    INPUT_MODE_PS4 = 3,
    INPUT_MODE_P5GENERAL = 4,
    INPUT_MODE_GENERIC = 5,
    INPUT_MODE_KEYBOARD = 6,
    INPUT_MODE_XBONE = 7,
    INPUT_MODE_MDMINI = 8,
    INPUT_MODE_NEOGEO = 9,
    INPUT_MODE_PCEMINI = 10,
    INPUT_MODE_EGRET = 11,
    INPUT_MODE_ASTRO = 12,
    INPUT_MODE_PSCLASSIC = 13,
    INPUT_MODE_XBOXORIGINAL = 14,
    INPUT_MODE_PS5 = 15,
    INPUT_MODE_SWITCH_PRO = 16,
